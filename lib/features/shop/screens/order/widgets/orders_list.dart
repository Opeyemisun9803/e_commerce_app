                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('27 Sept. 2025', style: Theme.of(context).textTheme.headlineSmall)
                    ],
                  ),
                ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('[#W20f5]', style: Theme.of(context).textTheme.titleMedium)
                          ],
                        ),
                      ),
                    ], 
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('01 Oct 2025', style: Theme.of(context).textTheme.titleMedium)
                          ],
                        ),
                      ),
