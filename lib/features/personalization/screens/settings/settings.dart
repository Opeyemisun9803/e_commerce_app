            ...
            // body
              ...
              child: Column(
                children: [
                  ...
                  const TSettingsMenuTile(icon: Iconsax.security, title: 'Acount Privacy', subtitle: 'Manage data usage and connected accounts'),                 

                  // App Settings
                   const SizedBox(height: TSizes.spaceBtwSections),
                   const TSectionHeading(title: 'App Settings', showActionButton: false),
                   const SizedBox(height: TSizes.spaceBtwItems),
                   const TSettingsMenuTile(icon: Iconsax.document, title: 'Load data', subtitle: 'upload data to your cloud firebass'),

                   TSettingsMenuTile(icon: Iconsax.location, title: 'Geololacttion', subtitle: 'Set recommendation based on location', trailing: Switch(value: true, onChanged: (value){})),
                   ...
                   TSettingsMenuTile(icon: Iconsax.image, title: 'No image Quality', subtitle: 'Set image quality to be seen', trailing: Switch(value: false, onChanged: (value){})),
